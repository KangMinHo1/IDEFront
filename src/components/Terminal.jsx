...
export default function Terminal() {
  ...
  const initTerminal = () => {
    ...
    try {
        ...
        if (workspaceId && activeProject) connectWebSocket(term, workspaceId);
  ...
  }, [workspaceId, activeProject, activeBranch]); // 의존성 추가
